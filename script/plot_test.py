...
ax1.plot(T, S_ising_clean)
ax1.plot(T, S_ising_disorder)
ax1.set_xlim([0, 5])
ax1.set_ylim([0, 1])
...
ax2.plot(T, S_ising_clean)
ax2.plot(T, S_ising_disorder)
ax2.plot(T, S_clock2_clean)
ax2.plot(T, S_clock2_disorder)
ax2.set_ylim([0, 1])
ax2.set_xlim([0, 5])
...
ax3.plot(T, S_clock20_clean)
ax3.plot(T, S_clock20_disorder)
...
ax4.plot(T, S_xy_clean)
ax4.plot(T, S_xy_disorder)
